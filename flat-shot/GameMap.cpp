...
GameMap::GameMap()
{
    if (!mapTex.loadFromFile(resourcePath() + "sprites/testingMapDensity.png"));                                //MAKE CHOOSABLE IN FUTURE
    ifstream blockMap;
    blockMap.open(resourcePath() + "maps/testingBlockMap.mp", ios::binary);
    ifstream densityMap;
    densityMap.open(resourcePath() + "maps/testingDensityMap.mp", ios::binary);
